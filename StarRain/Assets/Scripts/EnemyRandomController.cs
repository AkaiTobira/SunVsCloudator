...
public class EnemyRandomController : MonoBehaviour
{
    ...
    [HideInInspector] public int numberOfChild = 1;


    [SerializeField] private float timerStep = 1.2f;
    ...
    //    if ( Input.GetMouseButton(0) ){
            m_direction   = transform.parent.GetComponent<EnemiesController>().m_directions[index];//(mousePosition - transform.position).normalized;
